...
import '../model/attachment_delete_response.dart';
...
class AttachmentDeleteService {
  Future attachmentDeleteService({leadid,attachementid}
       ) async {
    ...
    try {
      var data = {
        "dashboard": "deleteleadattachment",
        "leadid":leadid??"",
      ...
      if (response.statusCode == 200) {
          ...
          return AttachmentDeleteModel.fromJson(jsonresponse);
        } else {
