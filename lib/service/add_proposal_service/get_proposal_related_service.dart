...
class GetProposalRelatedService {
  Future proposalRelatedService({leadid}) async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    var staffid = sharedPreferences.getString(Constants.staffid);
    log('enterrrrr');
    try {
      var data = {
        "dashboard": "getleadproposaldetails",
         "leadid":leadid??'',
      ...
      if (response.statusCode == 200) {
        ...
        return GetProposalRelatedModel.fromJson(jsonresponse);
      } else {
